...
namespace Kusto.Language.Parsing
{
    ...
    public class EngineCommandGrammar : CommandGrammar
    {
        ...
        internal override Parser<LexicalToken, Command>[] CreateCommandParsers(PredefinedRuleParsers rules)
        {
            ...
            var shape144 = CD("Query", CompletionHint.Literal);
            var shape145 = new [] {CD("ColumnName", CompletionHint.Column), CD()};
            var shape146 = new [] {CD(), CD(), CD("TableName", CompletionHint.Table), CD(), CD(), CD(), CD(CompletionHint.Column), CD()};
            var shape147 = new [] {CD(), CD(), CD("TableName", CompletionHint.Table), CD(), CD(), CD("ShardingPolicy", CompletionHint.Literal)};
            var shape148 = CD("UpdatePolicy", CompletionHint.Literal);
            var shape149 = new [] {CD(), CD(), CD("TableName", CompletionHint.Table), CD(), CD(), CD("UpdatePolicy", CompletionHint.Literal), CD(isOptional: true)};
            var shape150 = new [] {CD(), CD(), CD("TableName", CompletionHint.Table), CD(), CD(), CD(), CD(), CD(isOptional: true)};
            var shape151 = CD("rowStoreKey", CompletionHint.Literal);
            var shape152 = new [] {CD(), CD(), CD("TableName", CompletionHint.Table), CD(), CD(), CD(), CD("rowStoreKey", CompletionHint.Literal), CD(isOptional: true)};
            var shape153 = CD("rowStoreName", CompletionHint.None);
            var shape154 = new [] {CD(), CD(), CD("TableName", CompletionHint.Table), CD(), CD(), CD(), CD("rowStoreName", CompletionHint.None), CD(isOptional: true)};
            var shape155 = new [] {CD(), CD(CompletionHint.None), CD()};
            var shape156 = new [] {CD(), CD(), CD(CompletionHint.Table), CD(), CD(isOptional: true)};
            var shape157 = CD("DocString", CompletionHint.Literal);
            var shape158 = new [] {CD("ColumnName", CompletionHint.Column), CD(), CD("DocString", CompletionHint.Literal)};
            var shape159 = new [] {CD(), CD(), CD("TableName", CompletionHint.Table), CD(), CD(), CD(CompletionHint.Column), CD()};
            var shape160 = new [] {CD(), CD(), CD("tableName", CompletionHint.Table), CD(), CD(), CD(), CD(CompletionHint.Literal), CD(), CD(isOptional: true), CD("csl")};
            var shape161 = new [] {CD(), CD(), CD("TableName", CompletionHint.Table), CD(), CD("MappingKind"), CD(), CD("MappingName", CompletionHint.Literal), CD("MappingFormat", CompletionHint.Literal), CD(isOptional: true)};
            var shape162 = CD("TableName", CompletionHint.Database);
            var shape163 = new [] {CD(), CD(), CD("TableName", CompletionHint.Database), CD(), CD(), CD("Policy", CompletionHint.Literal)};
            var shape164 = CD("QueryOrCommand", CompletionHint.Tabular);
            var shape165 = CD("Path", CompletionHint.Literal);
            var shape166 = new [] {CD(), CD(), CD("tableName", CompletionHint.Table)};
            var shape167 = CD("Version", CompletionHint.Literal);
            var shape168 = new [] {CD(), CD(), CD("Version", CompletionHint.Literal)};
            var shape169 = new [] {CD("ReadOnly"), CD(isOptional: true)};
            ...
            var shape201 = new [] {CD(), CD("UserName", CompletionHint.Literal)};
            var shape202 = CD("ContinuousExportName", CompletionHint.None);
            var shape203 = new [] {CD(), CD(), CD("DatabaseName", CompletionHint.Database), CD("Role"), CD(), CD(CompletionHint.Literal), CD(), CD(isOptional: true), CD(CompletionHint.Literal, isOptional: true)};
            var shape204 = CD("IfExists");
            var shape205 = new [] {CD(), CD(), CD("DatabaseName", CompletionHint.Database), CD()};
            var shape206 = CD("SkipSeal");
            var shape207 = CD("d", CompletionHint.Literal);
            var shape208 = CD("TrimSize", CompletionHint.Literal);
            var shape209 = new [] {CD(), CD(), CD(), CD("TrimSize", CompletionHint.Literal), CD()};
            var shape210 = CD("LimitCount", CompletionHint.Literal);
            var shape211 = new [] {CD(), CD("LimitCount", CompletionHint.Literal)};
            var shape212 = CD("Older", CompletionHint.Literal);
            var shape213 = CD("ExtentId", CompletionHint.Literal);
            var shape214 = new [] {CD(), CD("TableName", CompletionHint.Table)};
            var shape215 = CD("externalTableName", CompletionHint.ExternalTable);
            var shape216 = new [] {CD(), CD(), CD(), CD("externalTableName", CompletionHint.ExternalTable), CD(), CD(), CD(CompletionHint.Literal), CD(), CD(isOptional: true), CD(CompletionHint.Literal, isOptional: true)};
            var shape217 = CD("serviceType", CompletionHint.Literal);
            var shape218 = new [] {CD(), CD(), CD(), CD("serviceType", CompletionHint.Literal), CD()};
            var shape219 = CD("operationRole");
            var shape220 = new [] {CD(), CD(), CD("FunctionName", CompletionHint.Function), CD("Role"), CD(), CD(CompletionHint.Literal), CD(), CD(isOptional: true), CD(CompletionHint.Literal, isOptional: true)};
            var shape221 = new [] {CD(), CD(), CD("FunctionName", CompletionHint.Function), CD()};
            var shape222 = CD("materializedViewName", CompletionHint.MaterializedView);
            var shape223 = new [] {CD(), CD(), CD("materializedViewName", CompletionHint.MaterializedView), CD(), CD(), CD(CompletionHint.Literal), CD(), CD(CompletionHint.Literal, isOptional: true)};
            var shape224 = new [] {CD(), CD(), CD("MaterializedViewName", CompletionHint.MaterializedView)};
            var shape225 = new [] {CD(), CD(), CD("rowStoreName", CompletionHint.None), CD(isOptional: true)};
            var shape226 = CD("containerId", CompletionHint.Literal);
            var shape227 = new [] {CD(), CD(), CD("TableName", CompletionHint.Table), CD("Role"), CD(), CD(CompletionHint.Literal), CD(), CD(isOptional: true), CD(CompletionHint.Literal, isOptional: true)};
            var shape228 = new [] {CD(), CD(), CD("TableName", CompletionHint.Table), CD()};
            var shape229 = new [] {CD(), CD(), CD("ContinuousExportName", CompletionHint.None)};
            var shape230 = new [] {CD(), CD(), CD(), CD(isOptional: true), CD(), CD(CompletionHint.Tabular)};
            var shape231 = new [] {CD(), CD(isOptional: true), CD(), CD(), CD(), CD(CompletionHint.Literal), CD(), CD(isOptional: true), CD(), CD("Query", CompletionHint.Tabular)};
            var shape232 = CD("Data", CompletionHint.None);
            var shape233 = CD("GUID", CompletionHint.Literal);
            var shape234 = CD("SourceTableName", CompletionHint.Table);
            var shape235 = CD("DestinationTableName", CompletionHint.Table);
            var shape236 = CD("NewColumnName", CompletionHint.None);
            var shape237 = CD("NewTableName", CompletionHint.None);
            var shape238 = CD("ExtentsToDropQuery", CompletionHint.Tabular);
            var shape239 = CD("ExtentsToMoveQuery", CompletionHint.Tabular);
            var shape240 = CD("StoredQueryResultName", CompletionHint.None);
            var shape241 = new [] {CD(), CD(isOptional: true), CD("TableName", CompletionHint.None), CD(isOptional: true), CD(), CD("QueryOrCommand", CompletionHint.Tabular)};
            var shape242 = new [] {CD(), CD(CompletionHint.Literal), CD(), CD(isOptional: true), CD(CompletionHint.Literal, isOptional: true)};
            var shape243 = new [] {CD(), CD(isOptional: true)};
            var shape244 = new [] {CD(), CD(), CD("DatabaseName", CompletionHint.Database), CD("Role"), CD()};
            var shape245 = CD("PrettyName", CompletionHint.Literal);
            var shape246 = new [] {CD(), CD(), CD("DatabaseName", CompletionHint.Database), CD(), CD("PrettyName", CompletionHint.Literal)};
            var shape247 = CD("viewName", CompletionHint.MaterializedView);
            var shape248 = new [] {CD(), CD(), CD(), CD(isOptional: true), CD()};
            var shape249 = CD("Tag", CompletionHint.Literal);
            var shape250 = new [] {CD(), CD(), CD("Tag", CompletionHint.Literal)};
            var shape251 = new [] {CD(), CD(), CD(), CD(), CD("policy", CompletionHint.Literal), CD()};
            var shape252 = new [] {CD(), CD(), CD(), CD(), CD(isOptional: true)};
            var shape253 = new [] {CD(), CD(), CD(), CD(isOptional: true)};
            var shape254 = new [] {CD(), CD(), CD("ContinuousExportName", CompletionHint.None), CD()};
            var shape255 = new [] {CD(), CD(CompletionHint.None)};
            var shape256 = new [] {CD(), CD(), CD(), CD("DatabaseName", CompletionHint.None), CD(isOptional: true), CD(), CD()};
            var shape257 = new [] {CD(), CD(), CD(), CD("DatabaseName", CompletionHint.Database), CD(), CD()};
            var shape258 = new [] {CD(), CD(), CD(), CD("DatabaseName", CompletionHint.Database), CD(), CD(CompletionHint.None), CD(), CD()};
            var shape259 = new [] {CD(), CD("Version", CompletionHint.Literal)};
            var shape260 = new [] {CD("DatabaseName", CompletionHint.Database), CD(isOptional: true)};
            var shape261 = CD("Details");
            var shape262 = new [] {CD(), CD(CompletionHint.Database)};
            var shape263 = CD("DatabaseName");
            var shape264 = new [] {CD(), CD(), CD("DatabaseName"), CD(), CD()};
            var shape265 = new [] {CD(), CD(), CD(), CD(isOptional: true), CD(isOptional: true)};
            var shape266 = new [] {CD(), CD(), CD(), CD(), CD(), CD(), CD(isOptional: true)};
            var shape267 = new [] {CD(), CD(), CD(), CD(), CD(isOptional: true), CD(isOptional: true)};
            var shape268 = new [] {CD(), CD(), CD(), CD(), CD(), CD(isOptional: true)};
            var shape269 = CD("name", CompletionHint.Literal);
            var shape270 = CD("databaseVersion", CompletionHint.Literal);
            var shape271 = new [] {CD(), CD("databaseVersion", CompletionHint.Literal)};
            var shape272 = CD("Script");
            var shape273 = new [] {CD(), CD(), CD(), CD(), CD(), CD(isOptional: true), CD(isOptional: true)};
            var shape274 = new [] {CD(), CD(), CD(), CD(), CD("Version", CompletionHint.Literal), CD(), CD(), CD(isOptional: true), CD(isOptional: true)};
            var shape275 = CD("flavor");
            var shape276 = new [] {CD(), CD(), CD("flavor"), CD(isOptional: true)};
            var shape277 = CD("obj", CompletionHint.Literal);
            var shape278 = new [] {CD(), CD(), CD("databaseName", CompletionHint.Database), CD(), CD(isOptional: true), CD(isOptional: true)};
            var shape279 = new [] {CD(), CD(), CD("databaseName", CompletionHint.Database), CD(), CD(), CD()};
            var shape280 = new [] {CD("Principal", CompletionHint.Literal), CD()};
            var shape281 = new [] {CD(), CD(), CD("databaseName", CompletionHint.Database), CD(), CD()};
            var shape282 = new [] {CD(), CD(), CD("DatabaseName", CompletionHint.Database), CD(), CD(), CD(), CD(isOptional: true), CD(isOptional: true)};
            var shape283 = new [] {CD(), CD(), CD("DatabaseName", CompletionHint.Database), CD(), CD(), CD(), CD(isOptional: true)};
            var shape284 = new [] {CD(), CD(), CD("DatabaseName", CompletionHint.Database), CD(), CD(), CD("Version", CompletionHint.Literal), CD(), CD(), CD(isOptional: true), CD(isOptional: true)};
            var shape285 = CD("Scope");
            var shape286 = new [] {CD(), CD(), CD(), CD(), CD("Scope"), CD()};
            var shape287 = new [] {CD(), CD(), CD("EntityGroupName", CompletionHint.EntityGroup)};
            var shape288 = new [] {CD(), CD(), CD(), CD("ExternalTableName", CompletionHint.ExternalTable), CD()};
            var shape289 = new [] {CD(), CD(), CD(), CD("ExternalTableName", CompletionHint.ExternalTable), CD(), CD("MappingName", CompletionHint.Literal)};
            var shape290 = new [] {CD(), CD(), CD(), CD("ExternalTableName", CompletionHint.ExternalTable)};
            var shape291 = new [] {CD(), CD(CompletionHint.Database), CD()};
            var shape292 = new [] {CD(), CD(), CD("FunctionName", CompletionHint.Function)};
            var shape293 = new [] {CD(), CD(), CD("MappingKind"), CD(), CD(isOptional: true)};
            var shape294 = new [] {CD(), CD(), CD("MaterializedViewName", CompletionHint.MaterializedView), CD()};
            var shape295 = new [] {CD(), CD(), CD("viewName", CompletionHint.MaterializedView), CD(), CD(isOptional: true)};
            var shape296 = new [] {CD(), CD(), CD("viewName", CompletionHint.MaterializedView), CD()};
            var shape297 = CD("OperationId", CompletionHint.Literal);
            var shape298 = CD("queryText");
            var shape299 = new [] {CD(), CD(), CD("tableName", CompletionHint.Table), CD()};
            var shape300 = new [] {CD(), CD(), CD("TableName", CompletionHint.Table), CD(), CD(), CD(isOptional: true)};
            var shape301 = CD("ShardsGroupId", CompletionHint.Literal);
            var shape302 = new [] {CD(), CD(), CD("TableName", CompletionHint.Table)};
            var shape303 = CD("eid", CompletionHint.Literal);
            var shape304 = CD("tableName", CompletionHint.None);
            ...
            Func<Source<LexicalToken>, int, SyntaxElement> missing10 = (source, start) => new SyntaxList<SeparatedElement<SyntaxElement>>(new SeparatedElement<SyntaxElement>((SyntaxElement)new CustomNode(shape145, rules.MissingNameReference(source, start), CreateMissingToken("asc", "desc"))));
            ...
            Func<Source<LexicalToken>, int, SyntaxElement> missing14 = (source, start) => new SyntaxList<SeparatedElement<SyntaxElement>>(new SeparatedElement<SyntaxElement>((SyntaxElement)new CustomNode(shape158, rules.MissingNameReference(source, start), CreateMissingToken(":"), rules.MissingStringLiteral(source, start))));
            ...
            Func<Source<LexicalToken>, int, SyntaxElement> missing60 = (source, start) => (SyntaxElement)new CustomNode(shape242, CreateMissingToken("("), new SyntaxList<SeparatedElement<SyntaxElement>>(new SeparatedElement<SyntaxElement>(rules.MissingStringLiteral(source, start))), CreateMissingToken(")"), CreateMissingToken("skip-results"), rules.MissingStringLiteral(source, start));
            ...
            Func<Source<LexicalToken>, int, SyntaxElement> missing62 = (source, start) => new SyntaxList<SeparatedElement<SyntaxElement>>(new SeparatedElement<SyntaxElement>((SyntaxElement)new CustomNode(shape250, CreateMissingToken("tags"), CreateMissingToken("!contains", "!has", "contains", "has"), rules.MissingStringLiteral(source, start))));
            Func<Source<LexicalToken>, int, SyntaxElement> missing63 = (source, start) => CreateMissingToken("roles");
            Func<Source<LexicalToken>, int, SyntaxElement> missing64 = (source, start) => new SyntaxList<SeparatedElement<SyntaxElement>>(new SeparatedElement<SyntaxElement>((SyntaxElement)new CustomNode(shape260, rules.MissingNameReference(source, start), (SyntaxElement)new CustomNode(shape259, CreateMissingToken("if_later_than"), rules.MissingStringLiteral(source, start)))));
            ...
            Func<Source<LexicalToken>, int, SyntaxElement> missing67 = (source, start) => (SyntaxElement)new CustomNode(shape243, CreateMissingToken("databases"), (SyntaxElement)new CustomNode(shape291, CreateMissingToken("("), SyntaxList<SeparatedElement<SyntaxElement>>.Empty(), CreateMissingToken(")")));
