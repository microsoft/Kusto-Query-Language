...
namespace Kusto.Language.Symbols
{
    ...
    public sealed class FunctionSymbol : TypeSymbol
    {
        ...
        /// </summary>
        public bool TryGetFunctionBodyFacts(GlobalState globals, out FunctionBodyFacts facts)
        {
            if (globals.IsDatabaseFunction(this))
            {
                return Binding.Binder.TryGetDatabaseFunctionBodyFacts(this, globals, out facts);
            }
            else
            {
                facts = this.NonDatabaseFunctionBodyFacts;
                return facts != null;
            }
        }

        /// <summary>
        /// Non-database function symbols exist only for the lifetime of a single expression tree,
