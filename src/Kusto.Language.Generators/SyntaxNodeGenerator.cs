...
#pragma warning disable CS0649
    ...
    /// <summary>
    /// Various options that control how <see cref="SyntaxNodeGenerator"/> will create the constructors.
    /// </summary>
    ...
    /// <summary>
    /// Various options that control how <see cref="SyntaxNodeGenerator"/> will create the Clone() method.
    /// </summary>
    ...
    public class SyntaxNodeGenerator
    {
        ...
        private System.Collections.Generic.Dictionary<string, SyntaxNodeInfo> m_nameToClass;
        private System.Collections.Generic.Dictionary<string, KnownTypeInfo> m_knownTypes;
            ...
            )
        {
            ...
            eg.m_nameToClass = new Dictionary<string, SyntaxNodeInfo>();
            foreach (var info in nodeInfos)
            {
                eg.m_nameToClass.Add(info.Name, info);
            }

            eg.m_knownTypes = new Dictionary<string, KnownTypeInfo>();
        ...
        {
            var lineage = new List<SyntaxNodeInfo>(); // First is the ultimate base, last is us
            var current = c;
            while (current != null)
            {
                lineage.Add(current);
